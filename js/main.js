...
$(document).ready(function(){
    ...
    $(".owl-carousel").owlCarousel({
        ...
        navText: ["<i class='fas fa-chevron-left' style='color: #03fd10;'></i>", 
        "<i class='fas fa-chevron-right' style='color: #000;'></i>"] // Personalizar el contenido de las flechas de navegación con iconos FontAwesome
    })
});